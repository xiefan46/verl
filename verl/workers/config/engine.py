...
class EngineConfig(BaseConfig):
    ...
    # When > 1, FSDP engine builds a CP process group via the device mesh and
    # plumbs it to each attention module so Magi's distributed FFA can dispatch
    # work across CP ranks.
