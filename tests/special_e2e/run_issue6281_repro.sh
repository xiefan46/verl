...
# This script runs fully async training with fsdp backend and multiple standalone
...
STUDENT_MODEL_ID=${STUDENT_MODEL_ID:-Qwen/Qwen3.5-2B}
GSM8K_TEACHER_MODEL_ID=${GSM8K_TEACHER_MODEL_ID:-Qwen/Qwen3.5-9B}
...
# GSM8K is prepared by verl-deploy/setup_env.sh into ~/data/gsm8k/.
...
STUDENT=(
    ...
    # --- use_policy_gradient = False, dont need config ref model
...
DISTILLATION=(
    ...
    +distillation.teacher_models.gsm8k.inference.gpu_memory_utilization=0.85
